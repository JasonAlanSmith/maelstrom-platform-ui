module.exports = {
  ...
  deploy: {
    production: {
      ...
      'pre-deploy-local': '',
      'post-deploy':
        'git pull && source ~/.nvm/nvm.sh && npm install && pm2 reload ecosystem.config.cjs --env production',
      'pre-setup': '',
    ...
    staging: {
      ...
      'pre-deploy-local': '',
      'post-deploy':
        'git pull && source ~/.nvm/nvm.sh && npm install && pm2 reload ecosystem.config.cjs --env staging',
      'pre-setup': '',
      ssh_options: 'ForwardAgent=yes',
    },
    qa: {
      ...
      'pre-deploy-local': '',
      'post-deploy':
        'git pull && source ~/.nvm/nvm.sh && npm install && pm2 reload ecosystem.config.cjs --env qa',
      'pre-setup': '',
      ssh_options: 'ForwardAgent=yes',
    },
    dev: {
      ...
      'pre-deploy-local': '',
      'post-deploy':
        'git pull && source ~/.nvm/nvm.sh && npm install && pm2 reload ecosystem.config.cjs --env dev',
      'pre-setup': '',
      ssh_options: 'ForwardAgent=yes',
    },
  },
